...
import { renderBasketball } from "./basketball/basketball.js";
...
const loadPage = (chartType) => {
  ...
  } else if (chartType === "basketball") {
    renderBasketball(contentDiv);
  }
};

window.loadPage = loadPage;
document.addEventListener("DOMContentLoaded", () => loadPage("basketball"));
